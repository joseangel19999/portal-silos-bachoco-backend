	...
	public void savePedidoTraslado(List<PedidoTrasladoSapResponseDTO> pedido, String claveSilo) {
		...
		for (PedidoTrasladoSapResponseDTO p : pedido) {
			if (p.getPedidoDeComprasAsociado() != null && p.getMaterial() != null && p.getNumeroPedTraslado() != null
				...
				params.put("p_cantidad_traslado",
						p.getCantidadPendienteTraslado() != null ? p.getCantidadPendienteTraslado() : 0);
				params.put("p_cantidad_recibida_pa",
						p.getCantidadRecibidaEnPa() != null ? p.getCantidadRecibidaEnPa() : 0);
				params.put("p_cantidad_pend_traslado",
						p.getCantidadPendienteTraslado() != null ? p.getCantidadPendienteTraslado() : 0);
