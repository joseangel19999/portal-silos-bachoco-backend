...
import com.bachuco.mapper.rowMapper.PedTrasladoCantDisponibleRowMapper;
...
public class PedidoTrasladoJdbcRepository {
	...
	public void savePedidoTraslado(List<PedidoTrasladoSapResponseDTO> pedido) {
		...
		for (PedidoTrasladoSapResponseDTO p : pedido) {
			if(p.getPedidoDeComprasAsociado()!=null && p.getMaterial()!=null) {
				...
				params.put("p_clave_silo",p.getPlantaDestino()); //FALTA CAMPO DE CONTRATO LEGAL
